...
public class Main {
    ...
    private static void scenario2() {
        ...
        if (house.getRoom("entrance").isPresent()) {
            ...
            List<Sensor> entranceSensors = new ArrayList<>(Arrays.asList(new Camera("entcam1", entrance.getCommHub()), new Camera("entcam2", entrance.getCommHub()), new HarmfulGasDetector("enthgd1", entrance.getCommHub()), new MotionSensor("entmos1", entrance.getCommHub())));
        ...
        if (house.getRoom("kitchen").isPresent()) {
            ...
            List<Sensor> kitchenSensors = new ArrayList<>(Arrays.asList(new Camera("kitcam1", kitchen.getCommHub()), new Camera("kitcam2", kitchen.getCommHub()), new HarmfulGasDetector("kithgd1", kitchen.getCommHub()), new MotionSensor("kitmos1", kitchen.getCommHub())));
        ...
        if (house.getRoom("living room").isPresent()) {
            ...
            List<Sensor> livingRoomSensors = new ArrayList<>(Arrays.asList(new Camera("livcam1", livingRoom.getCommHub()), new Camera("livcam2", livingRoom.getCommHub()), new Camera("livcam3", livingRoom.getCommHub()), new HarmfulGasDetector("livhgd1", livingRoom.getCommHub()), new MotionSensor("livmos1", livingRoom.getCommHub()), new MotionSensor("livmos2", livingRoom.getCommHub())));
        ...
        if (house.getRoom("bedroom").isPresent()) {
            ...
            List<Sensor> bedroomSensors = new ArrayList<>(Arrays.asList(new Camera("bedcam1", bedroom.getCommHub()), new Camera("bedcam2", bedroom.getCommHub()), new HarmfulGasDetector("bedhgd1", bedroom.getCommHub()), new MotionSensor("bedmos1", bedroom.getCommHub())));
        ...
        if (house.getRoom("bathroom").isPresent()) {
            ...
            List<Sensor> bathroomSensors = new ArrayList<>(Arrays.asList(new Camera("batcam1", bathroom.getCommHub()), new Camera("batcam2", bathroom.getCommHub()), new HarmfulGasDetector("bathgd1", bathroom.getCommHub()), new MotionSensor("batmos1", bathroom.getCommHub())));
